        ...
        <section className="text-gray-600 body-font">
          <div className="container px-10 pt-10 mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto font-sans">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug.</p>
            </div>
            ...
            <button className="flex mx-auto mt-16 text-white bg-primary border-0 py-2 px-8 focus:outline-none hover:bg-gold rounded text-lg">Button</button>
          </div>
        </section>
      );
    }
