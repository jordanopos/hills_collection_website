      ...
      <div className="container px-10 pt-10 mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto font-sans">
            We know choosing a watch provider is hard, let use help you make
        ...
        <button className="block w-full mx-auto mt-16 text-white bg-primary border-0 py-2 px-8 focus:outline-none hover:bg-gold rounded text-lg">
          Shop Now
        </button>
      </div>
    </section>
